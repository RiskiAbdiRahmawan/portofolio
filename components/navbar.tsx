...
const navItems = [
  ...
  { name: "Certifacates", href: "#certificates" },
  { name: "Contact", href: "#contact" },
];

const socialLinks = {
  github: "https://github.com./RiskiAbdiRahmawan",
  linkedin: "https://www.linkedin.com/in/riski-abdi-rahmawan-039786330/",
};
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className="max-7xl mx-auto px-6 py-3">
